      ...
      <div>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            onClick={onRepropose}
            disabled={isLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 border border-amber-500/40 rounded-lg text-xs font-medium transition-colors disabled:opacity-50"
          >
      ...
      <div className="flex items-center justify-between pt-1">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={onSkip}
            disabled={isLoading}
            className="flex items-center gap-1 px-3 py-1.5 bg-slate-800 text-slate-300 hover:bg-slate-700 rounded-lg text-xs font-medium transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            onClick={onAccept}
            disabled={isLoading}
            className="flex items-center gap-1.5 px-4 py-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-semibold shadow-lg shadow-blue-500/20 transition-all disabled:opacity-50"
          >
            <Check className="w-4 h-4" />
            {currentStep === totalSteps ? 'Accept & Finish' : 'Accept & Next'}
          </button>
        </div>
      </div>
    </div>
